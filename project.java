...
class CarRentalSystem {
    ...
    public void returnCar(Car car) {
        ...
        if (rentalToRemove != null) {
            ...
            rentalHistory.add(rentalToRemove); // Add to history
        } else {
    ...
    public void showCurrentRentals() {
        if (rentals.isEmpty()) {
            ...
            for (Rental rental : rentals) {
                ...
                System.out.println("Car: " + car.getBrand() + " " + car.getModel() + " (ID: " + car.getCarId() + ")");
...
public class project {
    public static void main(String[] args) {
        ...
        Car car4 = new Car("C004", "Toyota", "Camry", 80.0);
        Car car5 = new Car("C005", "Toyota", "Legender", 85.0);
        Car car6 = new Car("C006", "Tata", "Harrier", 70.0);
